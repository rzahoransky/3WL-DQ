...
//
//public class OldParticleSizeExtractor extends AbstractDQPipelineElement{
//
//	private MieList wl1;
//	private MieList wl3;
//	private MieList wl2;
...
//	}
//
//	public OldParticleSizeExtractor(MieList wl1, MieList wl2, MieList wl3) {
//		this.wl1 = wl1;
//		this.wl2 = wl2;
//		this.wl3 = wl3;
...
//	}
//	
//	public OldParticleSizeExtractor(File zippedMie) {
//		DQReader reader;
//		try {
...
//		}
//		try {
//		DQFieldEntry dq1Hits = dq1.getEntryFor(in.getDQ(DQtype.DQ1).getDqValue());
//		DQFieldEntry dq2Hits = dq2.getEntryFor(in.getDQ(DQtype.DQ2).getDqValue());
//		
...
//	}
//
//	private SigmaSize getMatchingEntries(DQFieldEntry dq1Hits, DQFieldEntry dq2Hits) {
