 ...
 * @since 1.0.5
 */
public class SampleDeviationRenderer extends XYLineAndShapeRenderer {
     ...
     */
    public SampleDeviationRenderer() {
        this(true, true);
    }
     ...
     */
    public SampleDeviationRenderer(boolean lines, boolean shapes) {
        super(lines, shapes);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SampleDeviationRenderer)) {
            return false;
        }
        SampleDeviationRenderer that = (SampleDeviationRenderer) obj;
